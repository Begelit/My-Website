...
SECRET_KEY = 'django-insecure-o3ho&4=mt2*c@+&@&h9#)9+v^hlenohxuidwu1$)xbituub4fo'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR.joinpath('dj_app','templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#ASGI_APPLICATION = 'dj_app.asgi.application'
